...
print('AesculaTech used ' + str(Total_Hours_aescula) + ' Hours in Week 3')
...
print('Alaunus used ' + str(Total_Hours_alaunus) + ' Hours in Week 3')
...
print('Alpine Roads used ' + str(Total_Hours_alpine) + ' Hours in Week 3')
...
print('Applaud used ' + str(Total_Hours_applaud) + ' Hours in Week 3')
...
print('Coral Genomics used ' + str(Total_Hours_coral) + ' Hours in Week 3')
...
print('Cypre used ' + str(Total_Hours_cypre) + ' Hours in Week 3')
...
print('Deciduous used ' + str(Total_Hours_deciduous) + ' Hours in Week 3')
...
print('Delve used ' + str(Total_Hours_delve) + ' Hours in Week 3')
...
print('Epiodyne used ' + str(Total_Hours_epiodyne) + ' Hours in Week 3')
...
print('Fountain used ' + str(Total_Hours_fountain) + ' Hours in Week 2')
...
print('GeneTether used ' + str(Total_Hours_genetether) + ' Hours in Week 3')
...
print('Gordian used ' + str(Total_Hours_gordian) + ' Hours in Week 3')
...
print('GraphWear used ' + str(Total_Hours_graphwear) + ' Hours in Week 3')
...
print('LogicInk used ' + str(Total_Hours_logicink) + ' Hours in Week 3')
...
print('Mammoth used ' + str(Total_Hours_mammoth) + ' Hours in Week 3')
...
print('Mitokinin used ' + str(Total_Hours_mitokinin) + ' Hours in Week 2')
...
print('Mojo used ' + str(Total_Hours_mojo) + ' Hours in Week 2')
...
print('Naked Biome used ' + str(Total_Hours_naked) + ' Hours in Week 3')
...
print('OneSkin used ' + str(Total_Hours_oneskin) + ' Hours in Week 3')
...
print('Prellis used ' + str(Total_Hours_prellis) + ' Hours in Week 3')
...
print('Provenance used ' + str(Total_Hours_provenance) + ' Hours in Week 3')
...
print('Quartz used ' + str(Total_Hours_quartz) + ' Hours in Week 3')
...
print('Rumi used ' + str(Total_Hours_rumi) + ' Hours in Week 3')
...
print('Scaled used ' + str(Total_Hours_scaled) + ' Hours in Week 3')
...
print('Scribe used ' + str(Total_Hours_scribe) + ' Hours in Week 3')
...
print('Siolta used ' + str(Total_Hours_siolta) + ' Hours in Week 3')
...
print('Soteria used ' + str(Total_Hours_soteria) + ' Hours in Week 3')
...
print('SyntheX used ' + str(Total_Hours_synthex) + ' Hours in Week 3')
...
print('Telo used ' + str(Total_Hours_telo) + ' Hours in Week 3')
...
print('Wild Type used ' + str(Total_Hours_wildtype) + ' Hours in Week 3')
...
rsltcompaniesdf1.to_excel('output3.xlsx')

output3 = pd.read_excel('output3.xlsx', index_col=None, 
	na_values=['NA'], usecols = 'B:C')

m1 = output3.iloc[:,1].ge(4)
m2 = output3.iloc[:,1].le(4)

output3.loc[m1,'Hours'] -= 4
output3.loc[m2,'Hours'] = 0


print('\nResult Week3 Billable :\n', output3)

output3.to_excel('week3bill.xlsx')