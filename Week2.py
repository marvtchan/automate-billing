...
print('AesculaTech used ' + str(Total_Hours_aescula) + ' Hours in Week 2')
...
print('Alaunus used ' + str(Total_Hours_alaunus) + ' Hours in Week 2')
...
print('Alpine Roads used ' + str(Total_Hours_alpine) + ' Hours in Week 2')
...
print('Applaud used ' + str(Total_Hours_applaud) + ' Hours in Week 2')
...
print('Coral Genomics used ' + str(Total_Hours_coral) + ' Hours in Week 2')
...
print('Cypre used ' + str(Total_Hours_cypre) + ' Hours in Week 2')
...
print('Deciduous used ' + str(Total_Hours_deciduous) + ' Hours in Week 2')
...
print('Delve used ' + str(Total_Hours_delve) + ' Hours in Week 2')
...
print('Epiodyne used ' + str(Total_Hours_epiodyne) + ' Hours in Week 2')
...
print('GeneTether used ' + str(Total_Hours_genetether) + ' Hours in Week 2')
...
print('Gordian used ' + str(Total_Hours_gordian) + ' Hours in Week 2')
...
print('GraphWear used ' + str(Total_Hours_graphwear) + ' Hours in Week 2')
...
print('LogicInk used ' + str(Total_Hours_logicink) + ' Hours in Week 2')
...
print('Mammoth used ' + str(Total_Hours_mammoth) + ' Hours in Week 2')
...
print('Naked Biome used ' + str(Total_Hours_naked) + ' Hours in Week 2')
...
print('Nitrome used ' + str(Total_Hours_nitrome) + ' Hours in Week 2')
...
print('OneSkin used ' + str(Total_Hours_oneskin) + ' Hours in Week 2')
...
print('Prellis used ' + str(Total_Hours_prellis) + ' Hours in Week 2')
...
print('Provenance used ' + str(Total_Hours_provenance) + ' Hours in Week 2')
...
print('Quartz used ' + str(Total_Hours_quartz) + ' Hours in Week 2')
...
print('Rumi used ' + str(Total_Hours_rumi) + ' Hours in Week 2')
...
print('Scaled used ' + str(Total_Hours_scaled) + ' Hours in Week 2')
...
print('Scribe used ' + str(Total_Hours_scribe) + ' Hours in Week 2')
...
print('Siolta used ' + str(Total_Hours_siolta) + ' Hours in Week 2')
...
print('Soteria used ' + str(Total_Hours_soteria) + ' Hours in Week 2')
...
print('SyntheX used ' + str(Total_Hours_synthex) + ' Hours in Week 2')
...
print('Telo used ' + str(Total_Hours_telo) + ' Hours in Week 2')
...
print('Wild Type used ' + str(Total_Hours_wildtype) + ' Hours in Week 2')
...
rsltcompaniesdf1.to_excel('output2.xlsx')
