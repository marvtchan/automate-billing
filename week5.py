...
rsltcompaniesdf1.to_excel('output5.xlsx')

output5 = pd.read_excel('output5.xlsx', index_col=None, 
	na_values=['NA'], usecols = 'B:C')

m1 = output5.iloc[:,1].ge(4)
m2 = output5.iloc[:,1].le(4)

output5.loc[m1,'Hours'] -= 4
output5.loc[m2,'Hours'] = 0


print('\nResult Week5 Billable :\n', output5)

output5.to_excel('week5bill.xlsx')